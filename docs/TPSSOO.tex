...
%BEGIN subsection
		\subsubsection{Usos}
		 ...
		 Este modulo procesa los archivos que se encuentren en la carpeta de aceptados, aplica sobre ellos los patrones del archivo maestro de patrones y mueve los archivos procesados a la carpeta de procesados. 
...
\end{verbatim}
		...
		\subsubsection{Ejemplo de invocación}
...
% c. Estructura
	...
	\subsection{Definidos en Enunciado}
		...
		\subsubsection{salida\_xxx}
			...
			\begin {itemize}
				\item \textbf{Nombre: } {salida\_YYYYMMDDHHMMSS}
